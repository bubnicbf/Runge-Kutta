%{
The normally-used built-in solver is the ode45 function, which uses a non-fixed-step solver with 4th/5th order 
Runge-Kutta methods. MathWorks released a package of fixed-step RK method ODE solvers on MATLABCentral, which
is on their website. The ode4 function contained within uses a 4th-order Runge-Kutta method.

Here is code that tests both ode4 and my own function, shows that they are the same, and compares them to the 
exact solution.
%}
